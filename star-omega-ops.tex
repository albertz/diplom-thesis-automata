...
This relation diagram was studied in detail for $\Langreg$ and the main relations where shown by Landweber in \cite{Landweber69}. In addition to the strict inclusions of the expressiveness power of the different automata acceptance conditions, he also showed that it is decidable for a Muller automaton to tell wether its accepted language can also be accepted by an E-/A-/Büchi-/co-Büchi-automaton, respectively.
