...
The set of all languages accepted by a non-deterministic Büchi automaton is exactly $\LangOreg$. (S218,R101) Deterministic Büchi automata are less powerful, e.g. they cannot recognise $(a+b)^* b^\omega$.
