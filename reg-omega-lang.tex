...
where $\BC$ (\defword{boolean combinations}: union, intersection, complement) is defined as:

Let $\mathcal{X} \subseteq \Sigma^\omega \mathbin{\dot\cup} \Sigma^*$. Then, $\BC \mathcal{X}$ is defined as the smallest set such that
\begin{itemize}
