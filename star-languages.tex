...
\begin{proof}
We proof it by recursion over boolean operations.

Let $w \in \Sigma^*$. Then,
\[ \ext \Set{w} = \dext \Set{w[0,n]}{n \in \N} , \]
\[ \dext \Set{w} = \emptyset = \ext \emptyset . \]
Let $L_1,L_2 \in \Lang(\mathtext{dot-depth-$0$})$. Then
\[ \ext (L_1 \cup L_2) = \ext L_1 \cup \ext L_2 = \dext L_1 \cup \dext L_2 \]
\end{proof}
\end{lemma}
