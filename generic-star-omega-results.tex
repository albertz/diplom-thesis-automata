...
Examples of such language classes are locally testable (\ref{lang:LT}) or piece-wise testable (\ref{lang:PT}) languages. At their definition, the word-relation basically tells wether a local test / piece-wise test can see a difference between two words.
