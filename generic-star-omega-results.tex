...
Let $\Lang$ be closed under suffix-independence, union, negation and change of final states. Then
...
Given the \emph{closure under change of final states}, we have $L^*(\A^E_S), L^*(\A^E_{S_+}) \in \Lang$.
