...
This exampe can be generalized a bit:

%\subsection{$op \cup \overline{op} \subsetneqq \BC op$}
\begin{lemma}
Let $\Lang$ be closed under negation and under alphabet permutation. Let there be an alphabet permutation non-invariant language $L \in \Lang$ with $\tilde L := \ext L \not\in \dext \Langreg$. Then
\[ \ext \cup \dext \Lang \subsetneqq \BC \ext \Lang . \]
\begin{proof}
Let $\sigma$ be a permutation such that $L_\sigma \neq L$. Because of the alphabet permutation closure, $L_\sigma \in \Lang$ and $\tilde L_\sigma := \ext L_\sigma \not\in \dext \Langreg$. I.e., $-\tilde L_\sigma = \dext (-L_\Sigma) \not\in \ext \Langreg$.
