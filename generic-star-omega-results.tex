...
Proof: Let $\A$ be a deterministic Büchi automaton for some language $\tilde L = L^\omega_{\text{B"uchi}}(\A) \in \Lang$ with final states $F$.
...
Thus,
\[ \tilde L = L^\omega_{\text{B"uchi}}(\A) = \bigcup_{q \in F} U_q V_q^\omega . \]
