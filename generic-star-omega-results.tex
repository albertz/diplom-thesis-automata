...
\BC \lim \Lang . \]
\begin{itemize}
\item If there is a $\Lang$-$\ext$-$\dext$-separating language $L_a$, the inclusion in (1) and (2) are strict.
\item If there is a $\Lang$-$\lim$-$\dlim$-separating language $L'_a$, the inclusion in (4) and (5) are strict.
\end{itemize}
\begin{proof}
