...
\]
\end{proof}
Let $\Lang := \Set{L^*(\A(F))}{F \subseteq Q}$. I.e. $L_3 := \Sigma(\Sigma\Sigma)^*$
\end{example}

Closure under suffix-independence is a very strong property as can be seen in \cref{gen:R-suffix-indep->single-state-loops}.
